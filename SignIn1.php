								...
								<form class="form-horizontal" method="post" style="text-align: justify;" r>
									...
									<div class="form-group">
									    <label class="control-label 	col-sm-4" for="email" style="text-align: left;">	Email:
										 ...
										 <div class="col-sm-5">
										   <input type="text" class="form-control" name="email" placeholder="Mailid">
										 </div>
										 <div class="col-md-3">
									...
									<div class="form-group">
						                  ...
						                  <div class="col-sm-5">   
						                    ...
						                    <div class="col-md-3">
										   		<span class="error">* <?php echo $roleErr;
										   		?></span>
										 </div>
						                </div>
								...
								<div class="form-group">
									...
									<div class="form-group">
									    <label class="control-label 	col-sm-4" for="email" style="text-align: left;">	Mobile No:
										 ...
										 <div class="col-sm-5">
										   <input type="text" class="form-control" name="mno" placeholder="Mobile">
										 </div>
										 <div class="col-md-3">
										   		<span class="error">* <?php echo $mnoErr;
										   		?></span>
										 </div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
									    <label class="control-label 	col-sm-4" for="email" style="text-align: left;">	Confirm Password:
										 ...
										 <div class="col-sm-5">
										   <input type="text" class="form-control" name="cpwd" placeholder="confirmpassword">
										 </div>
										 <div class="col-md-3">
