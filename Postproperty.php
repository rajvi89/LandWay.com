	...
	<div class="jarallax w3_agileits-contact w3ls-section text-center" id="contact">
		<div class="container">
			<div class="wthree-contact-top">
				<h3 class="agileits-title"><span>P</span>ost Free Poperty</h3>
					<div class="row">
						<div class="col-md-2">
						...
						<div class="col-md-8">
								<form class="form-horizontal" action="/action_page.php">
									...
									<div class="form-group">
									    <label class="control-label col-sm-2" for="email">Add Description:</label>
										    <div class="col-sm-10">
										      <textarea rows="2" cols="60" class="form-control"></textarea>
										    </div>
									</div>
									<div class="form-group">
									    <label class="control-label col-sm-2" for="email">Upload Image:</label>
										    <div class="col-sm-10">
										      <input type="file" class="form-control" id="email" placeholder="Upload Image">
										    </div>
									</div><hr>
									    ...
									    <div class="col-md-12">
									    	<div class="col-md-6">
									    		<div class="form-group">
												    ...
												    <div class="col-sm-10">
												      <input type="text" class="form-control" id="email" placeholder="Enetr Name">
											    	</div>
												</div>
											</div>
											<div class="col-md-6">
									    		<div class="form-group">
											    	<label class="control-label col-sm-2" for="email">Mob:</label>
												    <div class="col-sm-10">
												      <input type="text" class="form-control" id="email" placeholder="+91 1234567955">
											    	</div>
												</div>
											</div>
										</div>
										<div class="col-md-12">
									    	<div class="col-md-6">
									    		<div class="form-group">
												    ...
												    <div class="col-sm-10">
												      <input type="text" class="form-control" id="email" placeholder="abc@ymail.com">
											    	</div>
												</div>
											</div>
											<div class="col-md-6">
									    		<div class="form-group">
												    ...
												    <div class="col-sm-10">
												      <input type="text" class="form-control" id="email" placeholder="eg: Ahemdabad">
											    	</div>
												</div>
											</div>
										</div>
